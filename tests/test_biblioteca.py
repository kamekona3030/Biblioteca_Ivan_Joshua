...
class TestBiblioteca(unittest.TestCase):
    ...
    def test_mostrar_usuarios_con_datos(self, mock_list):
        ...
        # Verificar que no imprime "No hay usuarios"
